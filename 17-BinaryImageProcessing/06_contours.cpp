...
int main()
{
    ...
    // Fitting a bounding box (vertical or rotated) 
    // is the preferred choice in most cases but in cases 
    // where you are only dealing with circles or ellipses, 
    // fitting a circle and/or an ellipse is a much better choice.
